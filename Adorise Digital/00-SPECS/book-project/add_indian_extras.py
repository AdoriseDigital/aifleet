"""
add_indian_extras.py - Add India-specific Real Story / Workbook / Key Takeaway
to each `## N.` chapter of manuscript_indian.md.
Idempotent.
"""
import re
...
# India-specific stories, workbooks, takeaways for each chapter
EXTRAS = {
    "1. The Death of the Resume and the Rise of the Indian Operator": (
    ...
    "2. The New Economics of One (एक की नई अर्थव्यवस्था)": (
    ...
    "3. Picking the Right AI Side Hustle for Your Indian Life": (
        "Ankit was a B-school grad from IIM Lucknow who watched a YouTube short about 'AI agencies' and "
        "spent ₹60,000 on a course before he'd talked to a single prospect. Eight weeks later, broke and "
        "deflated, he called his uncle who runs a chain of four sweet shops in Lucknow. Ankit built a "
        "simple WhatsApp-based AI menu and order bot for the chain. The first shop paid him ₹15,000 to "
        "set it up. The other three paid the same the next month. Ankit's mistake wasn't picking AI. It "
        "was picking an idea that had nothing to do with his actual life.",
    ...
    "4. The Three Income Models That Actually Work in India": (
    ...
    "5. Your Solo AI Stack: Tools, Models, and Budgets That Scale on Indian Networks": (
        "A solo founder in Mumbai was burning ₹3,50,000 a month on OpenAI tokens because his app called "
        "GPT-4 for every support reply, even the easy ones. He split the traffic: GPT-4o-mini handled the "
        "first pass, GPT-4 only kicked in for anything flagged 'complex' by a tiny classifier. The same "
        "product. Same customers. Monthly bill dropped to ₹53,000. He didn't change the product. He "
        "changed the routing. After a quarter he switched 30% of the workload to Sarvam AI for Hindi "
        "queries, and the bill dropped another 40%.",
        "Pull up last month's bill for every AI tool you use. Sort the line items by cost, top to "
        "bottom. Now ask, for each one: would a smaller, cheaper model do 80% of this work, with a "
        "bigger model on call for the rest? Most Indian solo stacks have one fat line item that is "
        "silently eating margin.",
    ...
    "6. Building Your First Micro-SaaS in 30 Days (India Edition)": (
        ...
        "keywords, get three draft comments in English or Hindi. He put it on a ₹400/month server and "
        "posted it on a teachers' WhatsApp group. By day 14 he had 11 paying users at ₹200 a month. By "
        "day 30 he had 34. He never left his teaching job. He just stopped dreading Sundays for other "
        "people.",
    ...
    "7. Prompt Engineering as a Product Skill": (
        "Neha ran a copywriting agency in Mumbai. Her junior writers' first drafts were inconsistent: "
        "same brief, wildly different tone. She wrote a 600-word system prompt that locked down voice, "
        "banned specific words, and required a self-check before the model returned output. Within a "
        "week the variance collapsed. The prompt wasn't clever. It was specific. Specific beats clever "
        "every single time.",
    ...
    "8. Workflows, Agents, and the Automation That Replaces a Team": (
        ...
        "Shopify webhook → CSV → matching agent → exception list → WhatsApp alert → Google Sheet. The "
        "whole thing runs in 12 minutes. Nobody was fired. The four hours went back into finding new "
        "products.",
    ...
    "9. The Operator's Brand: Positioning in the Indian Market": (
        "Two consultants, both ex-McKinsey, both working on climate strategy, both with 15 years' "
        "experience. One called himself a 'sustainability thought leader.' The other said: 'I help "
        "cement plants in India get to net zero without buying new equipment.' The first got polite "
        "nods. The second got a ₹14 lakh retainer inside a month. The brand wasn't a logo. It was a "
        "sentence a prospect could repeat at a dinner.",
    ...
    "10. Pricing, Packaging, and the First 10 Customers (Razorpay Edition)": (
        "Vikram, a solo tax-consulting operator in Pune, priced his AI-assisted service at ₹2,000/month "
        "because 'it felt right.' Two months of silence. He tripled the price to ₹6,000, called the "
        "same leads, and got three sign-ups in a week. The lower price had signalled 'amateur' to "
        "exactly the customers he wanted. The higher price signalled 'I know what this is worth.' He "
        "was selling the same product.",
        ...
        "The price is not a number. It is a signal. Cheap signals 'maybe.' Expensive signals 'I have "
        "done this 50 times and I know what it costs to be wrong.'"
    ),
    "11. The First-Sale Playbook: Outreach Without Spam": (
        "Divya, a first-time founder in Bengaluru, sent 200 cold LinkedIn messages in week one and got "
        ...
        "with (Zoom, phone, in-person, WhatsApp). Rank them by how much they laughed. Message the top 10 "
    ...
    "12. Landing Pages That Convert at 5% or Better (India Edition)": (
        ...
        "that said 'Start free for 14 days' with a Razorpay checkout. Conversion rate: 5.4%. Same "
        "traffic. Same product. The difference was the page, not the product.",
    ...
    "13. Content as Distribution: YouTube, LinkedIn, and the Long Game": (
        "A chartered accountant in Surat started a YouTube channel explaining GST notices in plain "
        "Hindi. He hated public speaking. The first 14 videos had 200 views each. He kept going. The "
        "60th video got 380,000 views in a week. By month nine he was charging ₹50,000 a pop for a "
        "90-minute consultation and turning down clients. The product wasn't the videos. The product "
        "was the trust the videos built over nine quiet months.",
    ...
    "14. The Launch Week Calendar": (
        "Rohit, a solo SaaS founder in Hyderabad, launched on a Tuesday with no email list, no social "
        "following, and no plan. He made one sale. A month later he relaunched with a 14-day content "
        "ramp: 10 LinkedIn posts, 3 short videos, 1 podcast guest spot, and a 5-email sequence. Same "
        "product. 47 sales in the launch week. The product was identical. The runway was not.",
    ...
    "15. The 10x Operator: Doing 10x the Work Without 10x the Hours": (
        "Karthik, a one-man design agency owner in Bengaluru, worked 70-hour weeks and was burning out. "
        "He forced himself into a 30-hour week for 90 days. He cut his client list from 11 to 4, raised "
        "prices by 60%, and said no to every project that didn't fit. Revenue dropped 20% in month one. "
        "By month four it had grown 40% and he was taking Fridays off. Less hours. Better work. Same "
        "operator.",
    ...
    "16. Hiring Your First Contractor (Not an Employee) in India": (
        "Meera, a solo content operator in Mumbai, hired a 'social media manager' on a full-time "
        "salary at ₹35,000 a month. Six weeks later she realised she couldn't measure what they did, "
        "the work didn't show up, and she was paying for hours, not output. She let them go, hired a "
        "contractor on a ₹10,000/month retainer with a 30-piece monthly deliverable, and never looked "
        "back. The contractor was the same person, doing the same work. The contract was just honest.",
    ...
    "17. Building Recurring Revenue You Can Defend": (
        "A bootstrapped SaaS founder in Delhi had 200 paying customers and 14% monthly churn, meaning "
        "he had to sell 28 new customers every month just to stand still. He added a 14-day onboarding "
        "WhatsApp sequence, a 'first-success' milestone tracked in the product, and a 30-day personal "
        ...
        "List every customer who cancelled in the last 90 days. WhatsApp each one: 'What was the moment "
        "you stopped using it?' Take the top answer, build the fix this month, and watch churn fall. "
        "Most churn is one or two boring reasons, repeated.",
        "Recurring revenue is not a billing-cycle problem. It is a 'did the customer get what they "
        "came for in the first 14 days' problem. Fix the first 14 days and most of the churn "
        "disappears."
    ),
    "18. From Side Hustle to Solopreneur Business": (
        "Asha ran a wedding photography AI editing tool in Bengaluru on the side for two years while "
        "keeping her corporate job. When she finally quit to do it full-time, revenue dropped 30% in "
        "the first quarter because she'd lost the social proof of 'employed at a real company.' She "
        "fixed it by publishing monthly case studies, getting on two podcasts, and going from 'side "
        "project' to 'this is a company' in her own head first. Revenue was back above her salary in "
        "seven months.",
        "Write a one-paragraph 'origin story' of your business in the voice you'd use to explain it "
        "to your grandmother. If you can't, the business doesn't have a story yet, and the story is "
        "half the value.",
    ...
    "19. Selling the Engine: Exit Options for Indian Operators": (
        "Arjun built a niche AI tool for India-based therapists, hit ₹35 lakh MRR with 380 customers, "
        "and was approached by a larger SaaS company that offered 3.5x annual revenue. He said yes in "
        "two weeks. The tool was sold, integrated, and is still running. Arjun is on a beach in Goa "
        "writing the next book. Exit-readiness, not exit-intent, is what made the difference.",
        "Write down what would happen to your business if you disappeared for 6 months. If the answer "
        "is 'it would die,' you don't have an asset. You have a job. List the three things that would "
        "have to be true for it to survive your absence. Make one of those three true this month.",
    ...
    "20. The 90-Day Operator Sprint (India Plan)": (
        "Three friends in their late 20s — a CA in Surat, a marketing manager in Mumbai, and a software "
        "engineer in Bengaluru — quit their jobs on the same day in January 2025. They each picked a "
        "different niche (GST replies, AI listing descriptions, school WhatsApp bots). They each ran "
        "the 90-day sprint. By day 90, the CA had 18 paying customers and ₹36,000 MRR. The marketer "
        "had 22 customers and ₹88,000 MRR. The engineer had 9 customers but ₹1,80,000 MRR. All three "
        "had crossed the line. All three are now full-time. The 90-day plan works.",
        "Block 90 days on your calendar. Pick the one outcome that will define the quarter. Plan the "
        "30-day content ramp. Plan the launch-week calendar. Set the 5 weekly numbers. Show up every "
        "day. The plan is the practice. The practice is the business.",
    ...
    "21. The 1-Page Operating System": (
        "An operator in Pune taped a single A4 sheet to the wall above his desk in month 1. The sheet "
        ...
        "months. By month 36, his MRR was ₹18 lakh and he had 4 contractors. The A4 sheet is still "
        "on the wall. It is the entire operating system of a ₹2 crore/year business.",
        "Get one A4 sheet. Write the four questions in your handwriting. Tape it to the wall above "
        "your desk. Rewrite it on the first Monday of every month. The handwriting is the discipline.",
        "The 1-page OS is not a planning document. It is a way of being. The operator who plans from "
        "one page ships 10x more than the operator who plans from 40."
    ),
    "22. Failure Modes and How to Dodge Them": (
        "A Bengaluru operator spent 14 months polishing a 'complete' AI tool before showing it to a "
        "single customer. When he finally launched, the first three customers asked for the same "
        "feature he had removed in month 6 because he thought it was 'too complex.' He added it back "
        "in week 1 of the launch. The customers converted. The lesson cost him 14 months. The lesson "
        "was free.",
        "List the three things you have been avoiding in the business this month. Pick the smallest. "
        "Do it this week. The avoidance is the leak. The leak is the failure. The fix is the ship.",
        "Every failure mode is a slow leak. The slow leak is fixable. The fast failure is a gift. "
        "Don't fear the leak. Fix it. The fix is the practice."
    ),
    "23. The Operator's Code: Ethics, Health, and the Long Game": (
        "An operator in Delhi ran his business for 11 years on a simple code: never lie to a customer, "
        "never work on Sundays, never put his own health last. In year 11, he sold the business for "
        "₹4.2 crore. He took his family to Europe for 3 months. He came back and started the next "
        "business. The code survived the exit. The code survived the break. The code is the business.",
        ...
        "The code is not a list of restrictions. It is a list of freedoms. The freedom to say no. "
        "The freedom to walk away. The freedom to be a generational operator, not a one-book wonder."
    ),
}
